...
static void print_hexa(Elf32_Shdr shs, unsigned int index, Elf32_Ehdr *buff)
{
    char hexa;
...
static void in_section(Elf32_Ehdr *buff, Elf32_Shdr shs)
{
...
static void start_parsing(Elf32_Ehdr *buff, char *path)
{
    Elf32_Shdr *shs = (Elf32_Shdr*)((void *)buff + buff->e_shoff);
    Elf32_Shdr section = shs[buff->e_shstrndx];
